...
class AppStyle {
  ...
  static TextStyle txtJostRomanRegular10 = TextStyle(
  ...
  static TextStyle txtJostRomanRegular32 = TextStyle(
  ...
  static TextStyle txtRalewayRomanBold26 = TextStyle(
    color: ColorConstant.black900,
    fontSize: getFontSize(
      26,
    ),
  ...
  static TextStyle txtJostRomanRegular16 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      16,
    ),
  ...
  static TextStyle txtJostRomanRegular24 = TextStyle(
    color: ColorConstant.whiteA700,
    fontSize: getFontSize(
      24,
    ),
  ...
  static TextStyle txtInterRegular11Gray600 = TextStyle(
  ...
  static TextStyle txtRobotoRomanSemiBold15 = TextStyle(
  ...
  static TextStyle txtRobotoRomanMedium17 = TextStyle(
  ...
  static TextStyle txtInterRegular18Gray904 = TextStyle(
...
class CustomTextFormField extends StatelessWidget {
  ...
  _setFontStyle() {
    switch (fontStyle) {
      ...
      case TextFormFieldFontStyle.InterRegular11:
        return TextStyle(
          color: ColorConstant.gray600,
          fontSize: getFontSize(
            11,
  ...
  _setColor() {
    switch (variant) {
      case ButtonVariant.OutlineLightblue500:
        return ColorConstant.whiteA700;
      case ButtonVariant.OutlineLightblue500_1:
        return ColorConstant.whiteA700;
      case ButtonVariant.OutlineBlueA100:
        return ColorConstant.indigo903;
      case ButtonVariant.OutlineLightblue700:
